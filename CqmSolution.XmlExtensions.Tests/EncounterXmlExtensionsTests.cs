...
{
    public class EncounterXmlExtensionsTests
    {
        // This doesn't vary by test file, so no need to test all of them.
        [Theory]
        [XmlDocumentData("TestData/CCD/1.xml", "Client (1.xml)")]
        public void GetEncountersSetsClient(HtmlDocument doc, string testName)
        {
        ...
        public void GetEncountersSetsSectionType(HtmlDocument doc, string testName, string expected)
        {
            var client = doc.GetClient();
            var encounter = doc.GetEncounters(client).FirstOrDefault();
        ...
        [XmlDocumentData("TestData/CCD/2.xml", "DataSubType: Performed (2.xml)", "PRF")]
        [XmlDocumentData("TestData/CCD/3.xml", "DataSubType: Ordered (3.xml)", "ORD")]
        ...
        public void GetEncountersSetsDataSubType(HtmlDocument doc, string testName, string expected)
        {
            var client = doc.GetClient();
            var encounter = doc.GetEncounters(client).FirstOrDefault();
        ...
        [XmlDocumentData("TestData/CCD/2.xml", "Count: 28 (2.xml)", 28)]
        [XmlDocumentData("TestData/CCD/3.xml", "Count: 26 (3.xml)", 26)]
        ...
        public void GetEncountersReturnsCorrectCount(HtmlDocument doc, string testName, int expected)
        {
            var client = doc.GetClient();
        ...
        [XmlDocumentData("TestData/CCD/2.xml", "Code: OFFICE OUTPATIENT VISIT 15 MINUTES (2.xml)", "99213", null)]
        [XmlDocumentData("TestData/CCD/3.xml", "Code: null (3.xml)", null, null)]
        ...
        public void GetEncountersSetsCode(HtmlDocument doc, string testName, string expected, string nullFlavor)
        {
            var client = doc.GetClient();
            var encounter = doc.GetEncounters(client).FirstOrDefault();
        ...
        [XmlDocumentData("TestData/CCD/2.xml", "DateLow: Jun 14 2016 08:35:32 EST (2.xml)", "20160614083532-0500", null)]
        ...
        public void GetEncountersSetsVisitDateLow(HtmlDocument doc, string testName, string expected, string nullFlavor)
        {
            var client = doc.GetClient();
            var encounter = doc.GetEncounters(client).FirstOrDefault();
        ...
        [XmlDocumentData("TestData/CCD/2.xml", "DateHigh: Jun 14 2016 11:03:31 EST (2.xml)", "20160614110331-0500", null)]
        ...
        public void GetEncountersSetsVisitDateHigh(HtmlDocument doc, string testName, string expected, string nullFlavor)
        {
            var client = doc.GetClient();
            var encounter = doc.GetEncounters(client).FirstOrDefault();
        ...
        [XmlDocumentData("TestData/CCD/2.xml", "FacilityLocationCode: Any Age Mixed Acuity Unit (2.xml)", "1212-0", null)]
        [XmlDocumentData("TestData/CCD/3.xml", "FacilityLocationCode: Any Age Mixed Acuity Unit (3.xml)", "1212-0", null)]
        ...
        public void GetEncountersSetsFacilityLocationCode(HtmlDocument doc, string testName, string expected, string nullFlavor)
        {
            var client = doc.GetClient();
            var encounter = doc.GetEncounters(client).FirstOrDefault();
        ...
        [XmlDocumentData("TestData/CCD/2.xml", "FacilityLocationDateLow: null (2.xml)", null, null)]
        [XmlDocumentData("TestData/CCD/3.xml", "FacilityLocationDateLow: null (3.xml)", null, null)]
        ...
        public void GetEncountersSetsFacilityLocationDateLow(HtmlDocument doc, string testName, string expected, string nullFlavor)
        {
            var client = doc.GetClient();
            var encounter = doc.GetEncounters(client).FirstOrDefault();
        ...
        [XmlDocumentData("TestData/CCD/2.xml", "FacilityLocationDateHigh: null (2.xml)", null, null)]
        [XmlDocumentData("TestData/CCD/3.xml", "FacilityLocationDateHigh: null (3.xml)", null, null)]
        ...
        public void GetEncountersSetsFacilityLocationDateHigh(HtmlDocument doc, string testName, string expected, string nullFlavor)
        {
            var client = doc.GetClient();
            var encounter = doc.GetEncounters(client).FirstOrDefault();
        ...
        [XmlDocumentData("TestData/CCD/2.xml", "DischargeDisposition: null (2.xml)", null, null)]
        [XmlDocumentData("TestData/CCD/3.xml", "DischargeDisposition: null (3.xml)", null, null)]
        ...
        public void GetEncountersSetsDischargeDispositionCode(HtmlDocument doc, string testName, string expected, string nullFlavor)
        {
            var client = doc.GetClient();
            var encounter = doc.GetEncounters(client).FirstOrDefault();
        ...
        [XmlDocumentData("TestData/CCD/2.xml", "PrincipalDiagnosis: null (2.xml)", null, null)]
        [XmlDocumentData("TestData/CCD/3.xml", "PrincipalDiagnosis: null (3.xml)", null, null)]
        ...
        public void GetEncountersSetsPrincipalDiagnosisCode(HtmlDocument doc, string testName, string expected, string nullFlavor)
        {
            var client = doc.GetClient();
            var encounter = doc.GetEncounters(client).FirstOrDefault();
        ...
        [XmlDocumentData("TestData/CCD/2.xml", "EncounterDiagnosis: null (2.xml)", null, "UNK")]
        [XmlDocumentData("TestData/CCD/3.xml", "EncounterDiagnosis: null (3.xml)", null, null)]
        ...
        public void GetEncountersSetsEncounterDiagnosisCode(HtmlDocument doc, string testName, string expected, string nullFlavor)
        {
            var client = doc.GetClient();
            var encounter = doc.GetEncounters(client).FirstOrDefault();
        ...
        [XmlDocumentData("TestData/CCD/2.xml", "EncounterDiagnosisDateLow: null (2.xml)", null, "UNK")]
        [XmlDocumentData("TestData/CCD/3.xml", "EncounterDiagnosisDateLow: null (3.xml)", null, null)]
        ...
        public void GetEncountersSetsEncounterDiagnosisDateLow(HtmlDocument doc, string testName, string expected, string nullFlavor)
        {
            var client = doc.GetClient();
            var encounter = doc.GetEncounters(client).FirstOrDefault();
        ...
        [XmlDocumentData("TestData/CCD/2.xml", "EncounterDiagnosisDateHigh: null (2.xml)", null, null)]
        [XmlDocumentData("TestData/CCD/3.xml", "EncounterDiagnosisDateHigh: null (3.xml)", null, null)]
        ...
        public void GetEncountersSetsEncounterDiagnosisDateHigh(HtmlDocument doc, string testName, string expected, string nullFlavor)
        {
            var client = doc.GetClient();
            var encounter = doc.GetEncounters(client).FirstOrDefault();
